...
public class DynamicActivity extends AppCompatActivity {
    ...
    public void handleClickLoadRedFragment(View view) {
        ...
        fragmentTransaction.replace(R.id.dynamic_fragment_placeholder, new RedFragment(), "RED_TAG");
        fragmentTransaction.addToBackStack(null);
        fragmentTransaction.commit();

//        getSupportFragmentManager().beginTransaction()
//                .setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN)
//                .replace(R.id.dynamic_fragment_placeholder, new RedFragment())
//                .addToBackStack(null)
//                .commit();
    ...
    public void handleClickLoadBlueFragment(View view) {
        FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
        fragmentTransaction.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        fragmentTransaction.replace(R.id.dynamic_fragment_placeholder, new BlueFragment(), "BLUE_TAG");
        fragmentTransaction.addToBackStack(null);
        fragmentTransaction.commit();
